...
<body>
    ...
    <div class="login-box">
        <h2>Login</h2>
        <form id="loginForm" action="{{ route('admin.login') }}" method="POST" class="form">
            @csrf
            <div class="user-box">
                <input class="input" type="text" id="" name="email" required="">
                <label class="label" for="">Username</label>
            </div>
            <!-- /.user-box -->
            <div class="user-box">
                <input class="input" type="password" id="" name="password" required="">
